...
//
    ...
    @PostMapping ResponseEntity<Object> envia(@RequestBody Envio envio){
        Municipio populacao = servicoApi.converteMunicipio(envio.getPopulacao());
        Municipio idhm = servicoApi.converteMunicipio(envio.getIdhm());
        Envio envio1 = new Envio(envio.getNome(),envio.getUf(),envio.getRegiao(), populacao,idhm);
